...
def get_skincare_info(day, cycle_length=28):
    ...
    if 1 <= day <= 5:
        ...
        night_routine = """🌿 진정 케어: 시카/세라마이드 위주의 진정·보습 크림만 가볍게 바르기 ➡️ (5분후)
🧴 멜라토닝크림(10월까지) 기미,잡티에 콕콕 찍어바르기"""
...
🧴 멜라토닝크림(10월까지) 기미,잡티에 콕콕 찍어바르기"""
        ...
        night_routine = """🌙 저녁: 매트릭실+ 디바이스 흡수모드 ➡️ (5분후) 멜라토닝크림(10월까지) 기미,잡티에 콕콕 찍어바르기
🍑 클레이팩(전체orT존,나비존) 8분(촉촉할때 닦아내기) ➡️ 물기닦고 애크린겔 ➡️ 세럼/보습(듬뿍)"""
